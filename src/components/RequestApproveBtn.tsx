...
function RequestApproveBtn({ handleRequestApprove, address, isCompleted, isLoading }: RequestApproveBtnProps) {
        ...
        <>
            {
                isLoading ? (
                    ...
                    <Button onClick={handleRequestApprove} type="button" className="bg-green-700" disabled={!canApprove || isCompleted}>
                        Approve
                    </Button>
                )
            }
